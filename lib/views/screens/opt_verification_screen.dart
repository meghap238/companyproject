...
class OptVerificationScreen extends StatefulWidget {
  final int otp;
  const OptVerificationScreen({super.key, required this.otp,});
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text('$errorMsg dgdgdfg',style: AppStyle.blackClrtxtSyle(color: Colors.red,fontSize: 10.sp,fontWeight: FontWeight.w600),textAlign: TextAlign.center,),
                        ),
               ...
               if (formKey.currentState!.validate()) {
                    ...
                    setState(() async {
                      ...
                      // }
                        ...
                        //   print("dvc ${dvc}");
                        // VerifiedOtpModel? otpResponse = await ApiService().verifiedOtpApi(otp: widget.otp, deviceId: dvc!);
                        // if (otpResponse?.status == 200 || OTP == widget.otp) {
                        //   Navigator.of(context).pushReplacement(
                        //     MaterialPageRoute(
                        //       builder: (context) => RegistrationScreen(),
                        //     ),
